...
class_size<- class_size %>% mutate(DBN=str_c(CSD,`SCHOOL CODE`,sep="")) %>%
...
demographics_clean<-demographics %>% select(-Name,-female_per)
...
## 12. Confirm that Dataframes are Prepared for Joining ##
